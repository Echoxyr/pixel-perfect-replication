...
const tourSteps: TourStep[] = [
  {
    ...
    description: 'Questo è il tuo nuovo sistema integrato per la gestione di commesse, sicurezza e conformità. Ti guideremo attraverso le funzionalità principali.',
    icon: Sparkles,
  ...
  },
  {
    ...
    description: 'La Dashboard ti offre una panoramica immediata di tutte le commesse attive, task aperti, alert sicurezza e scadenze importanti.',
    icon: LayoutDashboard,
    route: '/dashboard',
    tip: 'Usa il selettore commessa per vedere i dati filtrati per ogni singola commessa.',
  },
  {
    id: 3,
    title: 'Gestione Commesse',
    description: 'Crea e gestisci le tue commesse con tutte le informazioni: committente, date, imprese coinvolte, lavoratori e documentazione.',
    icon: Construction,
    route: '/cantieri',
    tip: 'Ogni commessa ha una sua dashboard dedicata con tutti i dettagli.',
  },
  {
    id: 4,
    title: 'Sicurezza & HSE',
