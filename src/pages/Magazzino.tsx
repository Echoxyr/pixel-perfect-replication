  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card><CardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-xs text-muted-foreground">Movimenti Oggi</p><p className="text-2xl font-bold text-primary">{stats.movimentiOggi}</p></div><History className="w-8 h-8 text-primary/20" /></div></CardContent></Card>
      </div>
